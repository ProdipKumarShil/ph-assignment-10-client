...
const card = () => <>
  <div className="w-full  mb-4 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    ...
    <div className="px-5 pb-5">
      <Link href="#">
        <h5 className="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">Chef 1</h5>
      </Link>
      ...
      <div className="">
        <span className='flex items-center '>Like Her: <AiOutlineHeart  className='ml-2'/>1K+</span>
      </div>
      <div className="flex items-center justify-between">
        <span className="text-3xl font-bold text-gray-900 dark:text-white">Price: $599</span>
